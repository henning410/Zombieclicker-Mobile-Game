export default class Powerup {
  ...
  //draw the powerup and let it move
  draw(context) {
  ...
  //method that moves the Powerup with speed in pixels
  movePowerup(speed) {
    this.posX += this.lineVec.x * speed;
    this.posY += this.lineVec.y * speed;
  }

  //with this method we calculate the line's unit vector to let the Powerup move at the same speed
  getLineNormal() {
    //get the line vector
  ...
  //method that returns true if Powerup collides with rectangle, that is later our ammoBox and Gunbox
